...
| 0b#### | Binary arithmetic | `0b1010*2` | `20` |
| 0x## | Hexadecimal arithmetic | `0xFF+1` | `256` |
...
| and | AND bitwise operation | `and(0xFF,0x0F)` | `15` |
...
| bin | Returns as binary | `bin(255)` | `0b11111111` |
...
| not | NOT bitwise operation | `not(0b11110000, 8)` | `15` |
...
| shr | Shift right bitwise operation | `shr(256,4)` | `16` |
...
| xor | Exclusive OR bitwise operation | `xor(255,15)` | `240` |